...
export type Mutation = {
  ...
  deleteComment: DeleteCommentResoult;
  ...
  toggleLike?: Maybe<ToggleLikeResult>;
...
export type Query = {
  ...
  seeFollower: SeeFollowersResult;
...
export type QuerySeeFollowerArgs = {
  page: Scalars['Int'];
  userName: Scalars['String'];
};
...
export type DeleteCommentResoult = {
  __typename?: 'deleteCommentResoult';
  error?: Maybe<Scalars['String']>;
  ok: Scalars['Boolean'];
};
